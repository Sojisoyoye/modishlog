...
def upgrade() -> None:
    ...
    cols = [
        ...
        sa.Column("additional_expense_value_1", sa.Numeric(18, 2), nullable=True),
        sa.Column("additional_expense_key_2", sa.String(100), nullable=True),
        sa.Column("additional_expense_value_2", sa.Numeric(18, 2), nullable=True),
        sa.Column("additional_expense_key_3", sa.String(100), nullable=True),
        sa.Column("additional_expense_value_3", sa.Numeric(18, 2), nullable=True),
        sa.Column("additional_expense_key_4", sa.String(100), nullable=True),
        sa.Column("additional_expense_value_4", sa.Numeric(18, 2), nullable=True),
