        ...
        <div class="w-full max-w-md">
          ...
          <form (ngSubmit)="onLogin()">
            <div class="mb-4">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  name="email"
                  autocomplete="email"
                  class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm transition-colors focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 min-h-[44px] pl-10"
            ...
            <div class="mb-6">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm transition-colors focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 min-h-[44px] pl-10 pr-10"
                  required
                  minlength="8"
                />
                <button
            ...
            <button
              ...
              class="w-full rounded-lg bg-emerald-600 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-emerald-700 disabled:opacity-50 min-h-[44px] flex items-center justify-center gap-2"
            >
              @if (loading()) {
